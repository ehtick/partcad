...
LSP_SERVER = server.LanguageServer(name="PartCAD", version="0.7.141", max_workers=MAX_WORKERS)
...
def do_activate(params: lsp.ExecuteCommandParams) -> None:
    ...
    try:
        ...
        partcad_requirements = SpecifierSet(">=0.7.141")
        ...
        partcad.healthcheck.tests.run_healthchecks()
